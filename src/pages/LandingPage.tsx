        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center">
              ...
              <h3 className="text-lg font-semibold text-danatharu-blue mb-2">Transparan & Mudah</h3>
              <p className="text-gray-600 text-sm">Bandingkan suku bunga, tenor, dan setoran dari berbagai BPR dalam satu tampilan</p>
            </Card>
            ...
            <Card className="text-center">
              ...
              <h3 className="text-lg font-semibold text-danatharu-blue mb-2">Mitra BPR Terkurasi</h3>
              <p className="text-gray-600 text-sm">Semua BPR mitra telah melalui proses kurasi ketat dan memiliki track record baik</p>
            </Card>
